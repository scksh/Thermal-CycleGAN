...
# 경로 설정
base_dir = '/home/ricky/Data/datasets/person'
rgb_dir = os.path.join(base_dir, 'TrainA')
seg_dir = os.path.join(base_dir, 'TrainSegA')
output_dir = os.path.join(base_dir, 'output')
os.makedirs(output_dir, exist_ok=True)

# 파일 리스트 획득
file_list = sorted([f for f in os.listdir(rgb_dir) if f.lower().endswith('.jpg')])
